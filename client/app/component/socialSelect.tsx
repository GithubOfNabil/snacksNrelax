...
export const InstagramSelect:React.FC<propType> = ({setSelect}) => {
  return (
    <div>
      <div className="flex items-center justify-center bg-purple-600 h-16 w-24 rounded-lg" onClick={setSelect}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="90"
          height="50"
...
export const TiktokSelect:React.FC<propType> = ({setSelect}) => {
  return (
    <div>
      <div className="flex items-center justify-center bg-purple-600 h-16 w-24 rounded-lg" onClick={setSelect}>
        <svg
